  ...
  useEffect(() => {
    ...
    const loadArticles = async () => {
      try {
        ...
        const respStrategies = await fetchData(
          HOST_URL + "/api/publications-strategiques",
        );
    ...
    const loadToolsAndDevices = async () => {
      try {
        const toolsAndDevices = await fetchData(
          HOST_URL + "/api/outils-et-dispositifs",
        );
    ...
    <>
      <BrowserRouter>
        ...
        <div className="margin-footer">
          <Routes>
            {articles &&
              articles.map((typeArticle) =>
                typeArticle.data.map((data) => {
                  const slug = data.attributes.titre_de_la_carte
                    .split(" ")
                    .join("-")
                    .toLowerCase()
                    .normalize("NFD")
                    ...
                    case "breve":
                      return (
                        <Route
                          ...
                          element={
                            <PageBuilder
                              data={data.attributes.composants}
                              dataArticles={[]}
                              isHome={false}
                            />
                          }
                ...
                if (page.attributes.nom_de_page === home) {
                  return (
                    ...
                    <Route
                      ...
                      element={
                        <PageBuilder
                          data={page.attributes.Composants}
                  ...
                  <Route
                    ...
                    element={
                      <PageBuilder
                        ...
                        dataArticles={articles}
                        isHome={
                          page.attributes.nom_de_page === home ? true : false
                        }
                      />
                    }
                  />
            ...
            {toolsAndDevices &&
              toolsAndDevices.map((item) => {
                const slug = item.attributes.titre_de_la_carte
                  .split(" ")
                  .join("-")
                  .toLowerCase()
                  .normalize("NFD")
                ...
                return (
                  <Route
                    ...
                    element={
                      <PageBuilder
                        data={item.attributes.Composants}
                        dataArticles={[]}
                        isHome={false}
                      />
                    }
              ...
              axes.map((axe) => {
                return (
                  <Route
                    ...
                    element={
                      <PageBuilder
                        data={axe.attributes.Composants}
                        dataArticles={[]}
