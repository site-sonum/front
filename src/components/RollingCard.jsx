    ...
    if (!e.target.classList.contains("fr-btn")) {
      if (e.currentTarget.classList.contains("closed")) {
        ...
        e.currentTarget
          ...
          .classList.remove("rollingcard-arrow-close");
        e.currentTarget.classList.remove("closed");
        e.currentTarget
          .getElementsByTagName("svg")[0]
          .classList.add("rollingcard-arrow-open");
        e.currentTarget.classList.add("opened");
        if (
          e.currentTarget
            .querySelector(".rollingcard-content")
        ...
        e.currentTarget
          .querySelector(".rollingcard-content")
          .classList.remove("rollingcard-content-close");
        e.currentTarget
          .querySelector(".rollingcard-content")
          .classList.add("rollingcard-content-open");
      } else if (e.currentTarget.classList.contains("opened")) {
        //FERMETURE//
        e.currentTarget
          .getElementsByTagName("svg")[0]
          .classList.remove("rollingcard-arrow-open");
        e.currentTarget.classList.remove("opened");
        e.currentTarget
          .getElementsByTagName("svg")[0]
          .classList.add("rollingcard-arrow-close");
        e.currentTarget.classList.add("closed");
        e.currentTarget
          .querySelector(".rollingcard-content")
          .classList.remove("rollingcard-content-open");
        e.currentTarget
          .querySelector(".rollingcard-content")
          .classList.add("rollingcard-content-close");
      }
    }
  };
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          ...
          {data.texte_du_bouton && (
            ...
            >
              <Link to={data.lien_du_bouton} className="fr-btn">
                {data.texte_du_bouton}
              </Link>
            </div>
          )}
