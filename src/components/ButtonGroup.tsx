    ...
    <>
      {localdata && (
        <>
          <div
            key={localdata.id}
            className={`${rows == 1 ? (position[localdata.position] === "left" || position[localdata.position] === "right" ? position[localdata.position] : "center") : ""}
          ...
          >
            {localdata.groupe_de_boutons.map((button) => {
              return (
                <Link
                  to={button.page_cible}
                  target={
                    button.page_cible && button.page_cible.includes("https://")
                      ? "_blank"
                      : null
                  }
