      ...
      {localData && (
        <>
          {rows === 1 && (
            ...
            >
              {localData.Lien_telechargement &&
                localData.Lien_telechargement.length > 1 && (
                  <div
                          ...
                          <a
                            href={
                              lien.media_a_telecharger.data !== null
                                ? HOST_URL +
                                  lien.media_a_telecharger.data.attributes.url
                                : null
                            }
              ...
              {localData.Lien_telechargement &&
                localData.Lien_telechargement.length === 1 && (
                  <div
                    key={localData.id}
                    style={{ padding: "16px 48px 16px 32px" }}
                  >
                    <a
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        onDownload(
                          localData.Lien_telechargement[0].media_a_telecharger
                            .data.attributes.url,
                        );
                      }}
                      ...
                      {localData.Lien_telechargement.map((lien, index) => (
                        <li key={index}>
                          <a
                            ...
                            download={
                              lien.media_a_telecharger.data.attributes.name
                            }
                            id={`link-${index}`}
                            href={
                              lien.media_a_telecharger.data !== null
