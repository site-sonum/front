...
import { BlocFieldSimple } from "../types";
...
export const BlocFields: React.FC<BlocFieldsProps> = ({ data }) => {
  return (
    <div className="flexrow-container">
      <div
        className="champ-de-blocs"
          ...
          {data.Bloc_simple.map((b) => (
            <div key={b.id} className="bloc-simple">
              <Link
                to={b.page_cible}
                target={
                  b.page_cible && b.page_cible.includes("https://")
                    ? "_blank"
                    : undefined
                }
              >
